...
<form on:submit|preventDefault={addPoi} class="uk-form-stacked uk-text-left">
    <div class="uk-grid uk-grid-stack">
        <div class="uk-width-1-2@m">
            ...
            <div class="uk-margin">
                <label class="uk-form-label" for="form-stacked-text">Enter a Short Description</label>
                <div class="uk-form-controls">
                    <input bind:value={descshort} class="uk-input" id="orm-stacked-text" type="text" name="descshort" placeholder="Short Description">
                </div>
            </div>
            <div class="uk-margin">
